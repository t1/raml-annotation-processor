...
public class ProblemDetail implements Cloneable {
    ...
    public static final String APPLICATION_PROBLEM_JSON_SCHEMA =
            SchemaGenerator.schema(Type.of(ProblemDetail.class), APPLICATION_JSON);
    ...
    public static final String APPLICATION_PROBLEM_XML_SCHEMA =
            SchemaGenerator.schema(Type.of(ProblemDetail.class), APPLICATION_XML);
    ...
    static Function<Class<? extends ProblemDetail>, URI> TYPE_URI_FACTORY =
